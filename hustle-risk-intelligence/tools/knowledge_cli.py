...
def main() -> None:
    parser = argparse.ArgumentParser(description="Hustle Risk Intelligence notes CLI")
    ...
    if args.command == "query":
        ...
        print(generate_brief(args.topic, ["Dependency concentration remains a major downside risk.", "Cash strain should be escalated earlier."]))
