...
def main() -> None:
    parser = argparse.ArgumentParser(description="Hustle Revenue Intelligence notes CLI")
    ...
    if args.command == "query":
        ...
        print(generate_brief(args.topic, ["Pricing power is the first commercial control.", "Expansion should follow churn protection."]))
